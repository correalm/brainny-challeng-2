      ...
      <div className="sidebar">
        <div className='content'>
          <div className="content content-options">
            <SidebarOption id='1' text='Administradores' img={admin_avatar}   selected={selected} onClickFunction={ () => toggleSelected('1') }/>
            <SidebarOption id='2' text='Clientes'        img={client_avatar}  selected={selected} onClickFunction={ () => toggleSelected('2') } />
            <SidebarOption id='3' text='Colaboradores'   img={workers_avatar} selected={selected} onClickFunction={ () => toggleSelected('3') } />
          </div>
